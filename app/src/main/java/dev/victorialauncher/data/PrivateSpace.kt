...
fun shouldListProfile(
    ...
    isMainUser -> true
    // Zero is the launcher's own profile, -1 is a user the platform cannot find: neither can
    // key a row that concealment would later match, so neither may be listed.
