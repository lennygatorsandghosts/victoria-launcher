...
class ButtonActionTest {
    ...
    @Test
    fun `effectiveActions keeps left and right defaults empty even when quick-launch keys exist`() {
        ...
        assertEquals(ButtonAction.None, actions[ButtonSlot.SWIPE_RIGHT])
    }

    @Test
    fun `effectiveActions lets stored values win over defaults`() {
